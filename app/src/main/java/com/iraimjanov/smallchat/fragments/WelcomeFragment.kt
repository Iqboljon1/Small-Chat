...
import com.iraimjanov.smallchat.cc.CountryCode
...
class WelcomeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        if (networkHelper.isNetworkConnected()){
            ...
            findNavController().navigate(R.id.action_welcomeFragment_to_noInternetFragment)
        }
    ...
    private fun connection() {
        ...
        binding.nextCountryCode.setOnClickListener {
            findNavController().navigate(R.id.action_welcomeFragment_to_countryCodeFragment)
        }
        ...
        binding.cardNext.setOnClickListener {
            ...
            if (country != "Choose the country" && country != "Invalid country code" && number.isNotEmpty()) {
                findNavController().navigate(R.id.action_welcomeFragment_to_verificationFragment)
                PublicData.number = code+number
            } else {
                Toast.makeText(requireActivity(), "The country code does not include an error or number", Toast.LENGTH_SHORT).show()
            }
        }
    ...
    override fun onResume() {
        super.onResume()
        binding.edtCountryName.setText(PublicData.countryDB.names)
        binding.edtCode.setText(PublicData.countryDB.codes)
        binding.edtNumber.requestFocus()
    }

    private fun checkFirstTime(): Boolean {
        val sharedPreferences =
            requireActivity().getSharedPreferences("firstTime", Context.MODE_PRIVATE)
